import type { TripDocument, TripMeta, Family, Location, Route, Meal, Activity } from '@/types'
import type {
  CreateFamilyInput,
  CreateLocationInput,
  CreateRouteInput,
...
export interface TripRepository {
  ...
  updateTripMetadata(tripId: string, metadata: Partial<TripMeta>): Promise<void>
  ...
  updateMeal(tripId: string, mealId: string, updates: Partial<Meal>): Promise<Meal>
  ...
  updateActivity(tripId: string, activityId: string, updates: Partial<Activity>): Promise<Activity>
